...
import com.driagon.services.services.ICartService;
...
public class CartController {
    ...
    public ResponseEntity<List<CartItem>> getCart(@RequestHeader(value = "X-USER-ID") String userId) {
        ...
        List<CartItem> cartItems = this.service.getCart(userId);
    ...
    public ResponseEntity<Void> removeFromCart(@RequestHeader(value = "X-USER-ID") String userId, @PathVariable String productId) {
